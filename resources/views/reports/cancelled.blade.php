...
<div class="row" id="rpt_header">
	<div class="col-md-12">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li>
				<a href="{{ route('report.cancelled-issuances') }}">Cancelled Issuance Request</a>
			</li>
		</ul>
			...
			<form>
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<a href="{{ route('report.cancelled-issuances') }}" type="submit" class="btn green">Reset</a>
					</div>
				</div>
			</form>
		</div>
		...
		<div class="portlet">
			<div class="portlet-body">
				...
				<center>
					...
					<br>
					<h3>Cancelled Issuance Request</h3>
					<p>
				...
				<table class="table table-striped table-bordered table-hover" id="sample_1">
					...
					<tbody>
						...
						@empty
							<tr><td colspan="10" class="text-center">No cancelled request found.</td></tr>
						@endforelse
					</tbody>
				</table>
			</div>
...
<form id="export_form" method="post" action="{{ route('export.cancelled') }}" style="display: none;">
	@csrf
